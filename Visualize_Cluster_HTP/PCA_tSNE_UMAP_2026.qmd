...
We will use UMAP to plot the data and explore sample information. Bookmark the [UMAP Statquest video](https://www.youtube.com/watch?v=eN0wFzBA4Sc) to review again and again in the future.
...
We will use tSNE to plot the data and explore sample information. Bookmark the [tSNE Statquest video](https://www.youtube.com/watch?v=NEaUSP4YerM) to review again and again in the future.
