...
Here is another [post](https://dataaspirant.com/hierarchical-clustering-algorithm/) that is helpful.

This [post](datanovia.com/en/lessons/determining-the-optimal-number-of-clusters-3-must-know-methods/) describes the different approaches to find the optimal cluster number in hierarchical clustering, though these methods work in other clustering approaches.
...
#function to compute agglomerative coefficient, where 1 indicate strong, well-formed, consistent cluster
# and 0 represents completely random, disparate, and loose clusters.
ac <- function(x) {
...
![regression examples](https://mldemystified.com/posts/basics-of-ml/linear-regression/images/poly_regression_overfitting1.png#center)

We will be reviewing concepts from the following videos:
